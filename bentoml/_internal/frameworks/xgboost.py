...
def load(
    ...
    """
    Load a XGBoost model with the given tag from the local BentoML model store.

    Args:
        tag (:code:`Union[str, Tag]`):
            Tag of a saved model in the BentoML local model store.
        booster_params (`t.Dict[str, t.Union[str, int]]`):
            Params for xgb.core.Booster initialization.
        model_store (:mod:`~bentoml._internal.models.store.ModelStore`, default to :mod:`BentoMLContainer.model_store`):
            BentoML model store, provided by DI Container.

    Returns:
        :obj:`xgboost.core.Booster`: An instance of `xgboost.core.Booster` from the BentoML model store.
...
def save(
    ...
    *,
    ...
    """
    Save a model instance to the BentoML model store.
    ...
    Returns:
        :obj:`~bentoml.Tag`: A :obj:`tag` with the format `name:version` where `name` is the user-defined model's name, and a `version` generated by BentoML.
    ...
    .. code-block:: python
        ...
        # `save` the booster to BentoML model store:
